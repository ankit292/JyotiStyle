...
export default function Contact() {
  const [userDetailm, setUserDetail] = useState({});
  const userGet = () => {
            ...
            <div className="col-md-5">
              <form action="#" className="contact-form">
                <input
                  ...
                  id="name"
                  placeholder="Name..."
                  value={userDetailm ? userDetailm.fullName : "Name..."}
                />
                <input
                  type="text"
                  id="email"
                  placeholder="Email..."
                  value={userDetailm ? userDetailm.email : "Email..."}
                />
